...
// 더미 음악 데이터 표시 (API 키가 없을 때) - 변경된 버전
...
function getDummyMusicData(emotion) {
  ...
  const result = playlistData[emotion] || playlistData['무표정']; // 기본값으로 멜론 100
